...
def ingreso():
	if (validar()):
		...
		boton5=Button(ingresar,text="RETROCEDER",font="Arial 35",command=regreso,relief="raised",bd=5)
		boton5.pack(pady=10,ipadx=302,after=boton4)
...
imagen=imagen.resize((540,640),Image.LANCZOS)
img=ImageTk.PhotoImage(imagen)

def redimensionar(direccion,tamaño):
	return ImageTk.PhotoImage(Image.open(direccion).resize(tamaño,Image.LANCZOS))
...
botonsito.place(x=200,y=415,width=166,height=150)
